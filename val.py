...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default= r'/media/hanjie/新加卷/yolov10-lpc/datasets/train.yaml' , help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp249/weights/best.pt', help='model.pt path(s)')
