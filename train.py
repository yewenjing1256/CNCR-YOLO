...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    body = {
        "appToken": "AT_RzgJMRUAZYvcCqE7TcrZqtvyfjDIEA7q",
        "content": "训练已完成，请及时查看",
        "summary": "滴滴滴，训练已完成，请及时查看！！！",
        "contentType": 1,
        "topicIds": [],
        "uids": ["UID_1GlTPJWyCfHevH0q0qKOISdG4Z8M"]
    }
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=r'/media/hanjie/新加卷/ywj_1256/Yolov5_Magic-main/models/yolov5_CARAFE.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r'/media/hanjie/新加卷/ywj_1256/Yolov5_Magic-main/data/train.yaml', help='dataset.yaml path')
    ...
    # parser.add_argument('--modulation', default=False, help='DCNV2')
